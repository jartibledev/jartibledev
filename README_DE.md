...
# [:uk:](README.md) [:es:](README_ES) [:fr:](README_FR)
# Allo, Ich bin Sergio
### Ich bin der *Designer Grafish* leidenschaftlich über *UI/UX* der liebt designen die Abbildung und der lernt guitarren. 
---
## Tecnologie
### Dev tools
| Die Programmiersprache | FrameWorks / Libraries | Die Projeckte | 
| :---: | :--- | :--- |
...
| ![python](https://img.shields.io/badge/Python-FFD43B?style=for-the-badge&logo=python&logoColor=blue) | Tkinter / CustomKinter / GTK | [Monochromatic Palette Generator](https://github.com/jartibledev/plugin-monochromatic-palette-generator.git) 
...
---
## Die Sprache
| Die Sprache | Die Stufe |
|:---|:---:|
| :es: Spanisch (Die Sprachemater)| ![](https://geps.dev/progress/100) |
| :uk: Englisch (B1 Cambrigde) |![](https://geps.dev/progress/80) |
| :de: Deutsch (der Lernerprozess) |  ![](https://geps.dev/progress/10) |
| :fr: Französisch (die niedrige Stufe) |  ![](https://geps.dev/progress/25) |
---
## Studium
>### [Universidad de Málaga (UMA)](https://www.uma.es) (bildenge Kunst, 2018-2023)
>### [Universitat Politecnica de Valéncia (UPV)](https://www.upv.es) ( (Der Master von Abbildung und Design 2023-developing TFM)
### Die Kurs:
| Die Werkezeug  | Die Kurs |
| :--- | :--- |
| Indesing | Aufbaukurs von Adobe Indesing von UMA |
| Illustrator | Aufbaukurs von Adobe Illustrator von UMA |
| Textil illustration | Aufbaukurs von Textilillustration von UMA |
---
